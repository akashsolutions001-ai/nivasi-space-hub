...
import { R as LoaderCircle, ft as ArrowLeft, h as ToggleLeft, j as Pencil, k as Plus, m as ToggleRight, n as X, s as Users, w as Search } from "../_libs/lucide-react.mjs";
...
import { W as updateMessEmployee, ct as useEmployees, f as createMessEmployee, yt as useMesses } from "./hooks-BH6AsUXG.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.mess.employees-NhRA7Smp.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function MessMultiPicker({ allMesses, selectedIds, onChange }) {
	function toggle(id) {
		...
		children: [selectedIds.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: selectedIds.map((id) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					children: [m.messName, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => toggle(id),
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: selectedIds.length === 0 ? "Select mess(es)…" : "Add another mess…" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [allMesses.filter((m) => !selectedIds.includes(m.id)).map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
				value: m.id,
				children: m.messName
			}, m.id)), allMesses.every((m) => selectedIds.includes(m.id)) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "px-3 py-2 text-xs text-muted-foreground",
				children: "All messes selected"
			})] })]
		})]
	});
}
function EmployeeFormDialog({ open, onClose, existing, messes }) {
	...
	const [selectedMessIds, setSelectedMessIds] = (0, import_react.useState)(existing?.messIds ?? []);
	const [role, setRole] = (0, import_react.useState)(existing?.role ?? "MESS_EMPLOYEE");
	const [saving, setSaving] = (0, import_react.useState)(false);
	const [errors, setErrors] = (0, import_react.useState)({});
	function getMessNames(ids) {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: existing ? "Edit Employee" : "Add Employee" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "space-y-1",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Assigned Mess(es) *" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessMultiPicker, {
							allMesses: messes,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Role" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
								value: "MESS_EMPLOYEE",
								children: "Mess Employee"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
								value: "MESS_MANAGER",
								children: "Mess Manager"
							})] })]
						})]
					}),
				...
				children: isLoading ? Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, { className: "h-24 rounded-2xl" }, i)) : filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: search || messFilter !== "all" ? "No employees match your filters." : "No employees yet."
						}),
						!search && messFilter === "all" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							size: "sm",
							onClick: () => setCreateOpen(true),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
										variant: "outline",
										className: "text-[11px]",
										children: emp.role === "MESS_MANAGER" ? "Manager" : "Employee"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
										variant: "outline",
							...
							emp.messIds.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-1.5 flex flex-wrap gap-1",
								children: emp.messIds.map((id, i) => {
...
//#endregion
export { MessEmployeesPage as component };
