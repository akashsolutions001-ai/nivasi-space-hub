...
import { R as LoaderCircle, ft as ArrowLeft, u as UserCheck, v as Square, w as Search, y as SquareCheckBig } from "../_libs/lucide-react.mjs";
...
import { R as unassignStudentFromLaundry, X as updateStudentLaundryStatus, et as useAdmissions, lt as useLaundries, r as assignStudentToLaundry } from "./hooks-BH6AsUXG.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.laundry.assign-fVr9Kg_o.js
...
function LaundryAssignPage() {
	...
	const [unassigning, setUnassigning] = (0, import_react.useState)(null);
	...
	async function assignSingle(studentId, laundryId, laundryName, status) {
		setSingleAssigning(studentId);
		try {
			await assignStudentToLaundry(studentId, laundryId, laundryName, status || "active");
	...
	async function unassignSingle(studentId) {
	...
	async function updateStatusSingle(studentId, status) {
		setSingleAssigning(studentId);
		try {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: isLoading ? Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, { className: "h-20 rounded-2xl" }, i)) : filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					const laundryStatus = rawStatus === "paused" || rawStatus === "cancelled" ? rawStatus : "active";
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										currentLaundryId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex items-center gap-1",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
												value: laundryStatus,
												onValueChange: (v) => updateStatusSingle(student.id, v),
												disabled: singleAssigning === student.id,
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
													className: `h-6 w-28 text-[11px] font-medium capitalize border ${laundryStatus === "active" ? "border-success/30 bg-success/10 text-success" : laundryStatus === "paused" ? "border-warning/30 bg-warning/10 text-warning-foreground" : "border-destructive/20 bg-destructive/10 text-destructive"}`,
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {})
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
														value: "active",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [activeLaundries.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									...
									children: [singleAssigning === student.id && l.id !== currentLaundryId ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "size-3 animate-spin mr-1" }) : null, l.laundryName]
								}, l.id)), currentLaundryId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									variant: "outline",
									size: "sm",
									className: "h-7 text-xs border-destructive/40 text-destructive hover:bg-destructive/10",
									disabled: unassigning === student.id || singleAssigning === student.id,
									onClick: () => unassignSingle(student.id),
									children: [unassigning === student.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "size-3 animate-spin mr-1" }) : null, "Unassign"]
								})]
							})
						]
					}, student.id);
