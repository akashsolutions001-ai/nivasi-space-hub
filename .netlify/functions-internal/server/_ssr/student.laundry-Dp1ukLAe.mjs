...
import { M as Package, R as LoaderCircle, T as Scale, Z as CircleCheck, g as StickyNote, i as WashingMachine, it as ChevronDown, st as CalendarDays, tt as ChevronUp } from "../_libs/lucide-react.mjs";
import { r as useQueryClient } from "../_libs/tanstack__react-query.mjs";
import { D as getOrCreateStudentLaundryRecord, L as todayISTDateString, O as getWeekBounds, Tt as useStudentLaundryRecords, Y as updateStudentLaundryRecord, k as getWeekId, lt as useLaundries, mt as useLaundryPickupsForStudent } from "./hooks-BH6AsUXG.mjs";
import { t as Skeleton } from "./skeleton-DLRLwmh_.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { t as Badge } from "./badge-Bt-nVIZo.mjs";
import { t as StudentShell } from "./student-shell-7uf-Blpu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/student.laundry-Dp1ukLAe.js
...
function DailyLaundryLogsCard({ pickups }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scale, { className: "size-4 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-sm font-semibold",
					children: "Daily Laundry & Clothes Weight"
				})]
			}), open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronUp, { className: "size-4 text-muted-foreground" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "size-4 text-muted-foreground" })]
		}), open && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "border-t border-border divide-y divide-border",
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: [p && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
									...
									children: ["Delivery: ", del.status === "picked_up" ? "Delivered" : del.status]
								})]
							})]
						}),
						weight && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						notes && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StickyNote, { className: "size-3.5 shrink-0" }), notes]
						})
					]
				}, d);
			})
