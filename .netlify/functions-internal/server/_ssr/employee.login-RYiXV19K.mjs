...
import { R as LoaderCircle, o as UtensilsCrossed } from "../_libs/lucide-react.mjs";
import { t as Input } from "./input-DoD5W07l.mjs";
import { t as Label } from "./label-B1jF9p8Y.mjs";
import { n as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/employee.login-RYiXV19K.js
...
function EmployeeLoginPage() {
	...
	(0, import_react.useEffect)(() => {
		if (!loading && user) {
			...
			else if (userRole === "laundry_employee") navigate({
				to: "/employee/laundry",
				replace: true
			});
