...
import { r as useIsGlobalAdmin } from "./auth-DCFmY9CZ.mjs";
import { G as Eye, K as EyeOff, R as LoaderCircle, S as Share2, ft as ArrowLeft, i as WashingMachine, j as Pencil, o as UtensilsCrossed, p as Trash2, x as ShieldAlert } from "../_libs/lucide-react.mjs";
...
import { R as unassignStudentFromLaundry, X as updateStudentLaundryStatus, Z as updateStudentTiffinStatus, g as deleteAdmission, i as assignStudentToMess, lt as useLaundries, r as assignStudentToLaundry, x as fetchAdmission, yt as useMesses, z as updateAdmission } from "./hooks-BH6AsUXG.mjs";
import { t as Skeleton } from "./skeleton-DLRLwmh_.mjs";
import { t as AdminShell } from "./admin-shell-BntfqH5W.mjs";
...
import { t as Route } from "./admin.admissions._admissionId.index-DY2tQuSq.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.admissions._admissionId.index-C_AXp9IA.js
...
function LaundrySection({ data }) {
	const qc = useQueryClient();
	const { data: laundries = [] } = useLaundries();
	const [saving, setSaving] = (0, import_react.useState)(false);
	const currentLaundryId = data.laundryId ?? "";
	const rawStatus = data.laundryStatus;
	const currentStatus = rawStatus === "paused" || rawStatus === "cancelled" ? rawStatus : "active";
	const currentLaundry = laundries.find((l) => l.id === currentLaundryId);
	async function handleLaundryChange(laundryId) {
	...
	const statusColor = currentStatus === "active" ? "border-success/30 bg-success/10 text-success" : currentStatus === "paused" ? "border-warning/30 bg-warning/10 text-warning-foreground" : "border-destructive/20 bg-destructive/10 text-destructive";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "rounded-2xl border border-border bg-card p-5 shadow-soft",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WashingMachine, { className: "size-4 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-display text-base font-bold",
						children: "Laundry Service"
					})]
				}), saving && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "size-4 animate-spin text-muted-foreground" })]
			}),
			currentLaundry ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-3 rounded-xl border border-success/30 bg-success/5 px-3 py-2.5",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: ["Laundry: ", currentStatus]
						})]
					}),
					currentLaundry.ownerName && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-0.5 text-xs text-muted-foreground",
						children: ["Owner: ", currentLaundry.ownerName]
					}),
					currentLaundry.ownerPhone && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-xs text-muted-foreground",
						children: ["Phone: ", currentLaundry.ownerPhone]
					})
				]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mb-3 text-sm text-muted-foreground italic",
				children: "Not assigned to any laundry service yet."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
							className: "h-9 text-sm",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Select laundry…" })
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [currentLaundryId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							value: "unassign",
							children: "Unassign from Laundry"
						}), laundries.filter((l) => l.status === "active").map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							value: l.id,
							children: l.laundryName
						}, l.id))] })]
					})]
				}), currentLaundryId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs font-medium text-muted-foreground",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminShell, {
		...
		children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LaundrySection, { data }),
