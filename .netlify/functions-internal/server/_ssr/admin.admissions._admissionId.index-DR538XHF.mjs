...
import { J as updateStudentTiffinStatus, L as updateAdmission, b as fetchAdmission, g as deleteAdmission, ht as useMesses, i as assignStudentToMess } from "./hooks-Cx9bJ-2X.mjs";
...
import { t as Route } from "./admin.admissions._admissionId.index-DdAHtWAI.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.admissions._admissionId.index-DR538XHF.js
...
function MessSection({ data }) {
	...
	const currentMealPref = data.mealPreference ?? "";
		...
		children: [
			...
			currentMess ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					currentMealPref && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
						variant: "outline",
						className: "mt-1 text-[11px]",
						children: currentMealPref === "veg" ? "🟢 Veg" : "🔴 Non-Veg"
					})
				]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							onValueChange: (v) => handleMealPrefChange(v),
							disabled: saving,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
								className: "h-9 text-sm",
