...
import { D as RefreshCw, O as Receipt, X as CircleX, Y as Clock, Z as CircleCheck, it as ChevronDown } from "../_libs/lucide-react.mjs";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-Ct7oRji7.mjs";
import { St as usePayoutsByMess, st as useEmployeeByUid, yt as useMesses } from "./hooks-BH6AsUXG.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/employee.mess.payouts-C7bDU7fr.js
...
function ReceiptCard({ payout }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			className: "border-t border-border bg-muted/20 px-4 py-3 space-y-0.5",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					payout.messName && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
						label: "Mess",
						value: payout.messName
					}),
					payout.servicePeriod && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
						label: "Period",
						value: payout.servicePeriod
					}),
					(payout.studentCount ?? 0) > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
						label: "Students",
						value: String(payout.studentCount)
					}),
...
function MessEmployeePayoutsPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminShell, {
		title: "My Payouts",
		subtitle: assignedMessIds.map((id) => allMesses.find((m) => m.id === id)?.messName ?? id).join(", "),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [assignedMessIds.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
						value: messFilter,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
							...
							value: "all",
							children: "All Messes"
						}), assignedMessIds.map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							value: id,
							children: allMesses.find((m) => m.id === id)?.messName ?? id
						}, id))] })]
...
//#endregion
export { MessEmployeePayoutsPage as component };
