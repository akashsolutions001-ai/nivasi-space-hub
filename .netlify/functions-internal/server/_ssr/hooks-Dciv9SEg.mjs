...
//#region node_modules/.nitro/vite/services/ssr/assets/hooks-Dciv9SEg.js
...
async function fetchMessRequestsForMess(messId) {
	try {
		return (await getDocs(query(collection(getDb(), "messRequests"), where("messId", "==", messId), orderBy("createdAt", "desc"), limit(100)))).docs.map(mapMessRequest);
	} catch (error) {
